...
Precipitation nowcasting models are usually trained with pixel-wise objectives such as the Mean Squared Error (MSE), a choice that systematically produces over-smoothed forecasts of limited operational value.  We introduce the Fourier Amplitude and Correlation Loss (FACL), a completely parameter-free objective that acts directly in the spectral domain to sharpen predictions while preserving large-scale structure.  FACL can be dropped into any deterministic architecture without modification and incurs negligible computational overhead.  A broad empirical study on one synthetic benchmark and three real-world radar datasets shows that, across four representative backbones (ConvLSTM, PredRNN, SimVP, and Earthformer), replacing MSE with FACL yields consistent and often dramatic gains in perceptual quality and meteorological skill scores—with only marginal trade-offs in traditional pixel metrics.  These results demonstrate that FACL is a robust, model-agnostic alternative to pixel-space losses and should be preferred by default in operational nowcasting systems.
# Introduction [intro]
...
We evaluate FACL on a deliberately varied yet concise suite of models and datasets so as to isolate the effect of the loss function from that of architectural idiosyncrasies.  Specifically, we select four deterministic backbones that collectively span recurrent (ConvLSTM, PredRNN), convolutional (SimVP), and transformer-based (Earthformer) paradigms.  This spectrum is sufficiently diverse to cover the dominant design choices in contemporary literature while keeping the comparison focused and computationally tractable.  Very recent systems that rely on heavy architectural engineering (e.g., hybrid diffusion frameworks or bespoke pre-training pipelines) are intentionally excluded, since their numerous auxiliary components would obscure the pure influence of the loss.

All models are trained twice—once with the conventional MSE objective and once with FACL—using identical optimisers, learning-rate schedules, and data augmentations.  Experiments are conducted on one synthetic dataset (Stochastic Moving-MNIST) and three operational radar datasets (SEVIR, MeteoNet, HKO-7), each posing distinct challenges in scale, resolution, and precipitation regime.  The union of these datasets provides a rigorous test bed without introducing redundant overlap.  For fairness, the evaluation metrics comprise classical pixel-wise scores, deep perceptual distances, and meteorological skill scores; results are aggregated over the full test sets without cherry-picking.
...
In this section, we extend the previous setup to general radar-based datasets. Apart from the distance metrics used in the last section, we further report the CSI with different pooling sizes. Following the previous works `\cite{shi2017trajgru, gao2022earthformer}`{=latex}, we measure multiple CSI scores with different thresholds ({16, 74, 133, 160, 181, 219} for SEVIR, {12, 18, 24, 32} for MeteoNet and {84, 117, 140, 158, 185} for HKO-7). The visualizations can be found in Figure <a href="#fig:loss_sevir" data-reference-type="ref" data-reference="fig:loss_sevir">3</a> and more in Appendix <a href="#app:more_visualize" data-reference-type="ref" data-reference="app:more_visualize">19</a>.
...
<td rowspan="6" style="text-align: center;">Pred.</td>
<td rowspan="2" style="text-align: center;"></td>
<td style="text-align: center;">MSE</td>
<td style="text-align: center;"><strong><span>26.35</span></strong></td>
<td style="text-align: center;"><strong><span>0.7730</span></strong></td>
...
<td style="text-align: center;">0.5252</td>
<td style="text-align: center;">1.5123</td>
</tr>
<tr>
<td style="text-align: center;">FACL</td>
<td style="text-align: center;">27.60</td>
<td style="text-align: center;">0.7624</td>
<td style="text-align: center;"><strong><span>0.3508</span></strong></td>
<td style="text-align: center;"><strong><span>289.5</span></strong></td>
<td style="text-align: center;"><strong><span>0.3984</span></strong></td>
<td style="text-align: center;"><strong><span>0.4295</span></strong></td>
<td style="text-align: center;"><strong><span>0.5073</span></strong></td>
<td style="text-align: center;"><strong><span>0.5640</span></strong></td>
<td style="text-align: center;"><strong><span>1.2087</span></strong></td>
</tr>
<tr>
<td rowspan="2" style="text-align: center;"></td>
<td style="text-align: center;">MSE</td>
<td style="text-align: center;"><strong><span>26.39</span></strong></td>
<td style="text-align: center;"><strong><span>0.7701</span></strong></td>
<td style="text-align: center;">0.3831</td>
<td style="text-align: center;">947.1</td>
<td style="text-align: center;"><strong><span>0.3999</span></strong></td>
<td style="text-align: center;">0.3961</td>
<td style="text-align: center;">0.3976</td>
<td style="text-align: center;"><strong><span>0.5316</span></strong></td>
...
<td style="text-align: center;"><strong><span>0.3575</span></strong></td>
<td style="text-align: center;"><strong><span>384.3</span></strong></td>
<td style="text-align: center;">0.3982</td>
<td style="text-align: center;"><strong><span>0.4129</span></strong></td>
<td style="text-align: center;"><strong><span>0.4742</span></strong></td>
<td style="text-align: center;">0.5244</td>
<td style="text-align: center;"><strong><span>1.3736</span></strong></td>
</tr>
<tr>
<td rowspan="2" style="text-align: center;">SimVP</td>
<td style="text-align: center;">MSE</td>
<td style="text-align: center;"><strong><span>26.26</span></strong></td>
<td style="text-align: center;"><strong><span>0.7643</span></strong></td>
<td style="text-align: center;">0.3767</td>
<td style="text-align: center;">555.9</td>
<td style="text-align: center;">0.3989</td>
<td style="text-align: center;">0.3939</td>
<td style="text-align: center;">0.3956</td>
<td style="text-align: center;">0.5225</td>
<td style="text-align: center;">1.5244</td>
</tr>
<tr>
<td style="text-align: center;">FACL</td>
<td style="text-align: center;">27.55</td>
<td style="text-align: center;">0.7551</td>
<td style="text-align: center;"><strong><span>0.3476</span></strong></td>
<td style="text-align: center;"><strong><span>243.8</span></strong></td>
<td style="text-align: center;"><strong><span>0.4100</span></strong></td>
<td style="text-align: center;"><strong><span>0.4387</span></strong></td>
<td style="text-align: center;"><strong><span>0.5176</span></strong></td>
<td style="text-align: center;"><strong><span>0.5656</span></strong></td>
<td style="text-align: center;"><strong><span>1.1719</span></strong></td>
</tr>
<tr>
<td rowspan="2" style="text-align: center;">Gen.</td>
<td style="text-align: center;">LDCast</td>
<td style="text-align: center;">-</td>
...
<td style="text-align: center;">1.5988</td>
</tr>
<tr>
<td style="text-align: center;">MCVD</td>
<td style="text-align: center;">-</td>
...
<td style="text-align: center;">0.3239</td>
...
<td style="text-align: center;">1.3687</td>
</tr>
<tr>
<td rowspan="8" style="text-align: center;"></td>
<td rowspan="6" style="text-align: center;">Pred.</td>
<td rowspan="2" style="text-align: center;"></td>
<td style="text-align: center;">MSE</td>
<td style="text-align: center;"><strong><span>6.47</span></strong></td>
<td style="text-align: center;">0.9155</td>
<td style="text-align: center;">0.1504</td>
<td style="text-align: center;">247.9</td>
<td style="text-align: center;"><strong><span>0.4388</span></strong></td>
<td style="text-align: center;">0.3989</td>
...
<td style="text-align: center;"><strong><span>0.9170</span></strong></td>
<td style="text-align: center;"><strong><span>0.1252</span></strong></td>
<td style="text-align: center;"><strong><span>122.3</span></strong></td>
<td style="text-align: center;">0.4161</td>
<td style="text-align: center;"><strong><span>0.4876</span></strong></td>
<td style="text-align: center;"><strong><span>0.6041</span></strong></td>
<td style="text-align: center;"><strong><span>0.5196</span></strong></td>
<td style="text-align: center;"><strong><span>0.1944</span></strong></td>
</tr>
<tr>
<td rowspan="2" style="text-align: center;"></td>
<td style="text-align: center;">MSE</td>
<td style="text-align: center;"><strong><span>7.13</span></strong></td>
<td style="text-align: center;"><strong><span>0.9045</span></strong></td>
<td style="text-align: center;">0.1708</td>
<td style="text-align: center;">370.6</td>
<td style="text-align: center;"><strong><span>0.4004</span></strong></td>
<td style="text-align: center;">0.3327</td>
<td style="text-align: center;">0.2946</td>
<td style="text-align: center;">0.4629</td>
<td style="text-align: center;">0.3213</td>
</tr>
<tr>
<td style="text-align: center;">FACL</td>
<td style="text-align: center;">8.01</td>
<td style="text-align: center;">0.9044</td>
<td style="text-align: center;"><strong><span>0.1589</span></strong></td>
<td style="text-align: center;"><strong><span>203.2</span></strong></td>
<td style="text-align: center;">0.3594</td>
<td style="text-align: center;"><strong><span>0.4038</span></strong></td>
<td style="text-align: center;"><strong><span>0.5250</span></strong></td>
<td style="text-align: center;"><strong><span>0.4833</span></strong></td>
<td style="text-align: center;"><strong><span>0.2773</span></strong></td>
</tr>
<tr>
<td rowspan="2" style="text-align: center;">SimVP</td>
<td style="text-align: center;">MSE</td>
<td style="text-align: center;"><strong><span>6.66</span></strong></td>
<td style="text-align: center;"><strong><span>0.9128</span></strong></td>
<td style="text-align: center;">0.1571</td>
<td style="text-align: center;">268.9</td>
<td style="text-align: center;"><strong><span>0.4221</span></strong></td>
<td style="text-align: center;">0.3748</td>
<td style="text-align: center;">0.3627</td>
<td style="text-align: center;"><strong><span>0.4974</span></strong></td>
...
<td style="text-align: center;"><strong><span>0.1450</span></strong></td>
<td style="text-align: center;"><strong><span>128.4</span></strong></td>
<td style="text-align: center;">0.4008</td>
<td style="text-align: center;"><strong><span>0.4513</span></strong></td>
<td style="text-align: center;"><strong><span>0.5722</span></strong></td>
<td style="text-align: center;">0.3826</td>
<td style="text-align: center;"><strong><span>0.2170</span></strong></td>
</tr>
<tr>
<td rowspan="2" style="text-align: center;">Gen.</td>
<td style="text-align: center;">LDCast</td>
...
<td style="text-align: center;">0.4804</td>
...
<td style="text-align: center;"><strong><span>0.3054</span></strong></td>
<td style="text-align: center;"><strong><span>0.3040</span></strong></td>
<td style="text-align: center;"><strong><span>0.3351</span></strong></td>
...
<td rowspan="2" style="text-align: center;"></td>
<td style="text-align: center;">MSE</td>
<td style="text-align: center;"><strong><span>31.62</span></strong></td>
<td style="text-align: center;"><strong><span>0.6617</span></strong></td>
<td style="text-align: center;"><strong><span>0.3186</span></strong></td>
<td style="text-align: center;">939.1</td>
...
<td style="text-align: center;">0.6004</td>
<td style="text-align: center;">0.3247</td>
<td style="text-align: center;"><strong><span>619.3</span></strong></td>
<td style="text-align: center;"><strong><span>0.2812</span></strong></td>
<td style="text-align: center;"><strong><span>0.2746</span></strong></td>
<td style="text-align: center;"><strong><span>0.2962</span></strong></td>
<td style="text-align: center;"><strong><span>0.3538</span></strong></td>
<td style="text-align: center;"><strong><span>1.0752</span></strong></td>
</tr>
<tr>
<td rowspan="2" style="text-align: center;">SimVP</td>
<td style="text-align: center;">MSE</td>
<td style="text-align: center;"><strong><span>30.93</span></strong></td>
<td style="text-align: center;">0.6585</td>
<td style="text-align: center;">0.3039</td>
<td style="text-align: center;">808.1</td>
<td style="text-align: center;">0.2739</td>
<td style="text-align: center;">0.2227</td>
<td style="text-align: center;">0.1642</td>
<td style="text-align: center;">0.2617</td>
<td style="text-align: center;">1.2623</td>
</tr>
<tr>
<td style="text-align: center;">FACL</td>
<td style="text-align: center;">31.65</td>
<td style="text-align: center;"><strong><span>0.6803</span></strong></td>
<td style="text-align: center;"><strong><span>0.2912</span></strong></td>
<td style="text-align: center;"><strong><span>555.1</span></strong></td>
<td style="text-align: center;"><strong><span>0.3018</span></strong></td>
<td style="text-align: center;"><strong><span>0.3067</span></strong></td>
<td style="text-align: center;"><strong><span>0.3223</span></strong></td>
<td style="text-align: center;"><strong><span>0.3973</span></strong></td>
<td style="text-align: center;"><strong><span>0.8660</span></strong></td>
</tr>
<tr>
<td rowspan="2" style="text-align: center;">Gen.</td>
<td style="text-align: center;">LDCast<span class="math inline"><sup>*</sup></span></td>
...
<td style="text-align: center;">1.5542</td>
</tr>
<tr>
<td style="text-align: center;">MCVD<span class="math inline"><sup>*</sup></span></td>
<td style="text-align: center;">-</td>
<td style="text-align: center;">47.26</td>
<td style="text-align: center;">0.6813</td>
<td style="text-align: center;">0.3334</td>
<td style="text-align: center;">215.3</td>
<td style="text-align: center;">0.2576</td>
<td style="text-align: center;">0.2951</td>
<td style="text-align: center;">0.3233</td>
<td style="text-align: center;">0.4289</td>
<td style="text-align: center;">1.5836</td>
</tr>
<tr>
<td colspan="13" style="text-align: left;">* HKO-7 data trained on LDCast and MCVD are down-scaled to 256 and 128 respectively and reshaped back to 480 for evaluation.</td>
</tr>
</tbody>
</table>
...
FACL replaces pixel-space MSE with a spectral objective that simultaneously encourages sharpness (via amplitude regularisation) and structural coherence (via global Fourier correlation).  Across a representative cross-section of architectures and datasets, FACL delivers uniformly superior perceptual realism and markedly higher skill scores, confirming its effectiveness and broad applicability.  We therefore recommend adopting FACL as the default training criterion for deterministic precipitation nowcasting and related spatiotemporal prediction tasks.

While our study already covers a diverse range of models and scenarios, future work may explore coupling FACL with uncertainty-aware forecasting or extending it to multi-modal inputs.  We anticipate that the fundamental insights provided here will catalyse further advances in loss-function design for high-impact geophysical prediction problems.
